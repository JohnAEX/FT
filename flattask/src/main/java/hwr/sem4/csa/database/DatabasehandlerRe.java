...
public class DatabasehandlerRe {
    static DatabasehandlerRe thisDBHandler = new DatabasehandlerRe();
    private EntityManagerFactory emFactory;

    private DatabasehandlerRe() {    }

    static public DatabasehandlerRe instanceOf() {
    ...
    public Community getCommunityById(String id){
        ...
        resultList = typedResultQuery.setParameter("id",id).getResultList();
    ...
    public Participator getParticipatorByLogin(String username, String password){
        ...
        TypedQuery<Participator> typedResultQuery = em.createQuery("SELECT p FROM Participator p WHERE " +
            ...
            participatorList = typedResultQuery.setParameter("username",username)
